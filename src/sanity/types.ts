...
// Query: *[_type == "sequel" && references($movieID)] {          name,          "movies": movies[]->{            filmName,            "slug": slug.current,            "poster": poster.asset->url,            "posterlqip": (poster.asset->metadata).lqip          }| order(releaseDate desc)        }[0]

        ...
        <div className="relative mx-auto w-auto list-none rounded-xl tracking-normal sm:ml-5 sm:w-137.5">
          ...
          <li className="mt-4 w-auto animate-pulse rounded-xl bg-gray-900 font-bold text-gray-900 sm:w-fit">
            ...
            <span className="">
              ...
              Pellentesque habitant morbi tristique senectus et alsaune bornda debe alesuada fames ac turpis egestas.
              Praesent et urna aliquet, dapibus diam ac, faucibus elit. Vivamus id tortor risus. Suspendisse potenti.
              Nullam elementum ex id augue varius eros.
            </span>
          </li>

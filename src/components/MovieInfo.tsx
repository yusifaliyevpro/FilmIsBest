    ...
    <div className="rounded-10 relative mx-3 mb-20 flex h-auto w-fit flex-col items-center justify-center border border-solid border-slate-400 p-4 sm:mx-auto sm:flex-row sm:items-start sm:justify-between">
      ...
      <div className="rounded-10 relative mx-auto w-auto list-none tracking-normal sm:ml-5 sm:w-105">
        ...
        <div className="relative flex flex-nowrap items-center justify-end px-3 text-lg">
          <div className="relative mt-3 flex items-center gap-x-1 py-2 font-sans font-bold text-nowrap lg:mt-2">
        ...
        <div className="left-0 mb-9 box-border flex list-none flex-row justify-around pt-12 text-left sm:mb-0 sm:p-12">
          ...
          <li className="text-left font-bold text-balance text-slate-400">
            {t("MovieInfo.country")}
            <br />
